...
def main():
    ...
    parser.add_argument('--kl_constraint', type=float, default=0.01, help='hard constraint in the M-step')
    ...
    parser.add_argument('--alpha_scale', type=float, default=10.0, help='scaling factor of the lagrangian multiplier in the M-step')
    ...
    parser.add_argument('--alpha_max', type=float, default=1.0, help='maximum value of the lagrangian multiplier in the M-step')
    ...
    parser.add_argument('--log_dir', type=str, default="model_log", help='log directory')
