...
def main():
    ...
    parser.add_argument('--q_loss_type', type=str, default='l1', help='discount factor used in Policy Evaluation')
    ...
    parser.add_argument('--log_dir', type=str, default="hopper_p1_dual1_correct", help='log directory')
